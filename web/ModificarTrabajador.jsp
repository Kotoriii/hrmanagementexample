...
<html>
    <head>
        ...
        <title>Modificar Trabajador: (Nombre Trabajador)</title>
    </head>
    <body>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            <td>
                                <h2>
                                    Modificar Trabajador: (Nombre Trabajador) 
                                </h2>
                                <table class="table table-striped" style="width: 80%; margin-top: 5%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" id="precioPorHora" placeholder="<%= "precioXHora"%>" name="precioPorHora">
                                            </td>
                                        </tr>
